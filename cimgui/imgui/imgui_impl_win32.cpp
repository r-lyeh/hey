...
/*extern*/ IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);                 //< @r-lyeh // Use ImGui::GetCurrentContext()
/*extern*/ IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io);  //< @r-lyeh // Doesn't use ImGui::GetCurrentContext()

...
typedef enum {
    ...
    ImGuiInputFlags_RepeatMask_ = (int)ImGuiInputFlags_Repeat | ImGuiInputFlags_RepeatRateMask_ | ImGuiInputFlags_RepeatUntilMask_, //< @r-lyeh(int)
    ...
    ImGuiInputFlags_SupportedBySetNextItemShortcut = (int)ImGuiInputFlags_RepeatMask_ | ImGuiInputFlags_RouteTypeMask_ | ImGuiInputFlags_RouteOptionsMask_ | ImGuiInputFlags_Tooltip, //< @r-lyeh(int)
...
typedef enum {
    ...
    ImGuiDockNodeFlags_NoDocking = (int)ImGuiDockNodeFlags_NoDockingOverMe | ImGuiDockNodeFlags_NoDockingOverOther | ImGuiDockNodeFlags_NoDockingOverEmpty | ImGuiDockNodeFlags_NoDockingSplit | ImGuiDockNodeFlags_NoDockingSplitOther, //< @r-lyeh(int)
